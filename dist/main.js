...
/* harmony import */ var _plugins_init_select2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plugins/init_select2 */ "./lib/plugins/init_select2.js");
/* harmony import */ var _weather__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./weather */ "./lib/weather.js");
/* harmony import */ var _cities__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cities */ "./lib/cities.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#city-input').select2({ data: _cities__WEBPACK_IMPORTED_MODULE_3__["cities"] }); // <-- add the `data` option

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#city-input').select2({ width: '100%' });

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#city-input').on('select2:select', (event) => {
  const city = event.params.data.text;
  Object(_weather__WEBPACK_IMPORTED_MODULE_2__["getWeather"])(city);
});

const city = "Lisboa";
// const country = "pt";

submit.addEventListener('click', _weather__WEBPACK_IMPORTED_MODULE_2__["getWeatherByCoords"]);
...
const initSelect2 = () => {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.select2').select2(); // (~ document.querySelectorAll)
};
...
/*!************************!*\
  !*** ./lib/weather.js ***!
  \************************/
/*! exports provided: getWeather, getWeatherByCoords */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWeather", function() { return getWeather; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWeatherByCoords", function() { return getWeatherByCoords; });
